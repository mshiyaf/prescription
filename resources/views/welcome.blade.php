...
<head>
  ...
  <div class="modal fade bs-recurring-modal-lg in" tabindex="-1" role="dialog" aria-hidden="true" style="display: none; padding-right: 15px;">
    <div class="modal-dialog">
      <div class="modal-content">
            ...
            <div id="p_history" class="tab-pane">
      ...
      $("body").on('click',".prescription",function(){
		...
		function setDataTable(){
          ...
          "data":{"_token":"<?= csrf_token()?>"}
				...
				aaSorting: [[2, 'desc']],
				columns: [
					{ data: 'staff', name: 'bm_company_staff.staff_name' },
					{ data: 'service', name: 'bm_services.service_name' },
					{ data: 'time', name: 'appointment_time' },
					{ data: 'status', name: 'appointment_status' },
					{ data: 'name', name: 'bm_users.name' },
					{ data: 'mobile', name: 'bm_users.mobile_number' },
					{ data: 'email', name: 'bm_users.email' },
					{ data: 'address', name: 'bm_users.address' },
  ...
  <script type="text/javascript">$(".greetings").fadeOut(5000);</script>
