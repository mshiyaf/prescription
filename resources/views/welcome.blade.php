	  ...
	  function appointment_manage(id, action){
		...
		function setDataTable(){
			$('#datatable-responsive').DataTable({
				...
				processing: true,
				serverSide: true,
				ajax: '/dashboard/today-appointment',
				aaSorting: [[2, 'desc']],
				columns: [
					{ data: 'staff_name', name: 'bm_company_staff.staff_name' },
					{ data: 'service_name', name: 'bm_services.service_name' },
					{ data: 'appointment_time', name: 'appointment_time' },
					{ data: 'appointment_status', name: 'appointment_status' },
					{ data: 'name', name: 'bm_users.name' },
					{ data: 'mobile_number', name: 'bm_users.mobile_number' },
